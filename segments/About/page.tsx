...
const countryLocations = [
  ...
  },
  {
    ...
    bgImage: "/assets/superlabhero.png",
  ...
  return (
    <section id="about" ref={container}>
      <div className="container">
        ...
        <div className="map-achievement-container">
          <NigeriaMap />
          <Achievement />
        </div>
