...
const BoxAnimation: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    viewBox="0 0 602 602"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    {...props}
    className={`box__animation__svg ${props.className || ''}`}
    style={{
      filter: 'drop-shadow(0 0 20px rgba(92, 178, 179, 0.15))',
      ...props.style
    }}
  >
    ...
    <defs>
      ...
      >
        <stop offset="0.2" stopColor="#5cb2b3" stopOpacity="0.8" />
        <stop offset="0.5" stopColor="#b2b2b2" stopOpacity="0.4" />
      ...
      <radialGradient
        ...
        gradientTransform="translate(301 301) rotate(90) scale(300)"
      >
        <stop offset="0.2" stopColor="#945DD6" stopOpacity="0.6" />
        <stop offset="0.5" stopColor="#b2b2b2" stopOpacity="0.4" />
        <stop offset="1" stopColor="white" stopOpacity="0" />
      </radialGradient>
      <radialGradient
        ...
        gradientTransform="translate(301 301) rotate(90) scale(300)"
      >
        <stop offset="0.2" stopColor="#F46737" stopOpacity="0.6" />
        <stop offset="0.5" stopColor="#b2b2b2" stopOpacity="0.4" />
        <stop offset="1" stopColor="white" stopOpacity="0" />
      </radialGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#945DD6" stopOpacity="0.9" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F46737" stopOpacity="0.9" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#5cb2b3" stopOpacity="0.9" />
        <stop offset="1" stopColor="#5cb2b3" stopOpacity="0" />
      </linearGradient>
    </defs>
  </svg>
);

export default React.memo(BoxAnimation);